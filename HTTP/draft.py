"""
    ...
    гипертекстовых документов в формате HTML, в настоящее время используется
    для передачи произвольных данных.

    По большому счету это просто соглашение о формате текстовых файлов
    (передаваемых пакетов), между сервером и клиентом
